...
const NS_ENT = 'https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aduanas/es/aeat/aden/enswsv5/IE313V5Ent.xsd';
...
<soapenv:Envelope xmlns:soapenv="${NS_SOAP}">
  <soapenv:Body>
    <ent:IE313V5Ent xmlns:ent="${NS_ENT}">
      <CC313A>
        <MesSenMES3>${carrierEORI}</MesSenMES3>
        <MesRecMES6>NECA.ES</MesRecMES6>
        <DatOfPreMES9>${prepDate}</DatOfPreMES9>
        <MesIdeMES19>${transId}</MesIdeMES19>
